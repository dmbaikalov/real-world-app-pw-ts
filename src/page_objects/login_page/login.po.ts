...
export class LoginPage extends BasePage {
    ...
    private usernameInput: Locator = this.page.getByRole("textbox", { name: "Username" });
    private passwordInput: Locator = this.page.getByRole("textbox", { name: "password" });
    private signInBtn: Locator = this.page.getByRole("button", { name: "Sign In" });
    private signUpBtn: Locator = this.page.getByText("Don't have an account? Sign Up");
    private rememberMeBtn: Locator = this.page.getByLabel("Remember Me");
    private errorMsg: Locator = this.page.getByRole('alert').getByText('Username or password is invalid')
    ...
    private signUpPasswordInput: Locator = this.page.locator('input[name="password"]');
    private confirmPasswordInput: Locator = this.page.getByRole("textbox", { name: "Confirm Password" });
    private submitBtn: Locator = this.page.getByRole("button", { name: "Sign Up" });
    ...
    async clickSignUpBtn(): Promise<void> {
        console.info(">>> Clicking on 'Don't have an account?' link to navigate to Sign Up page");
    ...
    async fillSignUpForm(firstName: string, lastName: string, username: string, password: string, confirmPassword: string): Promise<void> {
